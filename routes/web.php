...
Route::delete('/events/leave/{id}', [EventController::class, 'leaveEvent'])->middleware('auth')->name('leaveEvent');
...
Route::post('/deleteUser/{id}', [EventController::class, 'deleteUser'])->middleware('auth')->name('deleteUser');
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
